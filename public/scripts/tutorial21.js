 ...
 */
  ...
  * Our application is now feature complete but it feels slow to have to wait for the request to complete 
  * before your comment appears in the list. 
...
/* Congrats!
 * You have just built a comment box in a few simple steps. 
 * Learn more about why to use React, or dive into the API reference and start hacking! 
 * Good luck!
 */ 